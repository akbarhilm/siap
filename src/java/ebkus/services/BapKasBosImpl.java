...
import ebkus.entity.BapKasBosMapper;
...
@Service("bapKasBosServices")
public class BapKasBosImpl implements BapKasBosServices {

    private static final Logger log = LoggerFactory.getLogger(BapKasBosImpl.class);

    @Autowired
    private BapKasBosMapper bapKasMapper;
    ...
    public void insertBapKasAll(BapKas bapKas) {
        ...
        for (BapKasRinci bapKasRinci : list) {
            ...
            id2.setNamaTabel("TMBKUSBOSBARINCI");
