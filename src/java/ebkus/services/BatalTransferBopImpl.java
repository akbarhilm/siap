...
import ebkus.entity.BatalTransferBopMapper;
...
@Service("batalTfBopServices")
public class BatalTransferBopImpl implements BatalTransferBopServices {

    private static final Logger log = LoggerFactory.getLogger(BatalTransferBopImpl.class);
    @Autowired
    private BatalTransferBopMapper bkuMapper;
