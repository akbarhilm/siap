...
import ebkus.entity.BatalTutupBkuBopMapper;
...
@Service("batalTutupBkuBopServices")
public class BatalTutupBkuBopImpl implements BatalTutupBkuBopServices {

    private static final Logger log = LoggerFactory.getLogger(BatalTutupBkuBopImpl.class);

    @Autowired
    private BatalTutupBkuBopMapper tutupBkuMapper;
