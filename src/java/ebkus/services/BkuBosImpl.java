...
@Service("bkuBosServices")
public class BkuBosImpl implements BkuBosServices {
...
// create ID BKU MASTER
            ...
            for (BkuRinci bkurinci : list) {
                id3.setNamaTabel("TMBKUSBOSRINCI");
    ...
    public void insertBkuPajak(BukuKasUmum bku) {
        ...
        // insert spj pajak dan netto pake procedure
        if (("PN".equals(bku.getJenisPembayaran())) && ("0".equals(bku.getKodePajak()))) {
    ...
    public void updateBkuPajak(BukuKasUmum bku) {
        ...
        for (BkuRinci bkurinci : list) {
            ...
            if (idrinci > 0) {
                bkuMapper.updatePajakRinciByIdbkubos(bkurinci);
            } else {
                // create ID BKU RINCI
                id2.setNamaTabel("TMBKUSBOSRINCI");
                genMapper.insertGetId(id2);
    ...
    @Override
    public BigDecimal getSaldoAwal(final Map<String, Object> param) {
    ...
    public void updateBkuC12(BukuKasUmum bku) {
        ...
        log.debug("RINCI 1 " + rinci1.getIdEntry());
        ...
        log.debug("RINCI 1 " + rinci1.getNilaiMasuk());
        log.debug("RINCI 1 " + rinci1.getNilaiKeluar());
    ...
    @Override
    public Integer getCountSaldoAwal(Map<String, Object> param) {
        return bkuMapper.getCountSaldoAwal(param);
    }
