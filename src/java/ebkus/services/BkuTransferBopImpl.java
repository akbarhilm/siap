...
import ebkus.entity.BkuTransferBopMapper;
...
@Service("bkuTfBopServices")
public class BkuTransferBopImpl implements BkuTransferBopServices {

    private static final Logger log = LoggerFactory.getLogger(BkuTransferBopImpl.class);
    @Autowired
    private BkuTransferBopMapper bkuMapper;
    ...
    @Override
    public BkuTransfer getDataBankBOP(final Map<String, Object> param) {
        return bkuMapper.getDataBankBOP(param);
    }
    ...
    public BkuTransfer getKodeStan(final Map param) {
        ...
        BkuTransfer bkuTransfer = new BkuTransfer();
        bkuTransfer.setKodeStan(new DecimalFormat("000000").format(newkodestan));
        bkuTransfer.setNomorRef(new DecimalFormat("0000000000").format(newkodestan));
        bkuTransfer.setTglProses(bkuMapper.getKodeStan(param).getTglProses());
        return bkuTransfer;
    }
    ...
    @Override
    public List<BukuKasUmum> getListPajakPnBop(final Map<String, Object> param) {
        return bkuMapper.getListPajakPnBop(param);
    }
    ...
    @Override
    public void insertResponse(Map param) {
        bkuMapper.insertResponse(param);
    }
