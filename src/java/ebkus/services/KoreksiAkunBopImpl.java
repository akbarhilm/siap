...
import ebkus.entity.KoreksiAkunBopMapper;
...
@Service("koreksiAkunBopServices")
public class KoreksiAkunBopImpl implements KoreksiAkunBopServices {

    private static final Logger log = LoggerFactory.getLogger(KoreksiAkunBopImpl.class);
    @Autowired
    private KoreksiAkunBopMapper koreksiMapper;
