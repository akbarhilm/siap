...
import ebkus.entity.KoreksiNilaiSpjBosMapper;
...
@Service("koreksiNilaiSpjBosServices")
public class KoreksiNilaiSpjBosImpl implements KoreksiNilaiSpjBosServices {

    private static final Logger log = LoggerFactory.getLogger(KoreksiNilaiSpjBosImpl.class);
    @Autowired
    private KoreksiNilaiSpjBosMapper koreksiMapper;
