...
import ebkus.entity.PASekolahMapper;
import ebkus.entity.GenerateIdMapper;
 ...
 * @author zaenab
 */
@Service("paSekolahServices")
@Transactional(readOnly = true)
public class PASekolahImpl implements PASekolahServices {

    @Autowired
    private PASekolahMapper pasekolahMapper;
    ...
    @Override
    public List<PASekolah> getListPASekolah(Map<String, Object> map) {
        return pasekolahMapper.getListPASekolah(map);
    }

    @Override
    public Integer getBanyakListPASekolah(Map<String, Object> map) {
        return pasekolahMapper.getBanyakListPASekolah(map);
    }
    
    @Override
    @Transactional(readOnly = false)
    public void insertPASekolah(Map param) {
        pasekolahMapper.insertPASekolah(param);
        pasekolahMapper.nonAktifPa(param);

    }
    
    @Override
    @Transactional(readOnly = false)
    public void nonAktifPaPlt(Map param) {
       
        pasekolahMapper.nonAktifPaPlt(param);
