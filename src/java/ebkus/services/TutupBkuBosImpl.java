...
import ebkus.entity.TutupBkuBosMapper;
...
@Service("tutupBkuBosServices")
public class TutupBkuBosImpl implements TutupBkuBosServices {

    private static final Logger log = LoggerFactory.getLogger(TutupBkuBosImpl.class);

    @Autowired
    private TutupBkuBosMapper tutupBkuMapper;
