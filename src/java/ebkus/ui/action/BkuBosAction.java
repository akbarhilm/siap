...
import ebkus.services.BkuBosServices;
 ...
 */
@Controller
@RequestMapping("/bkubos")
public class BkuBosAction extends PrintReportTemplate {

    private static final Logger log = LoggerFactory.getLogger(BkuBosAction.class);
    private static final String resourceUrl = "http://soadev.jakarta.go.id/rest/gov/dki/simpeg/ws/getPegSIPKD";

    @Autowired
    BkuBosServices bkuServices;
    @Autowired
    PajakTransferBosServices pajakServices;
...
//            mapData.put(splited[5].split("\"")[3], splited[6].split("\"")[1]);
    ...
    public ModelAndView index(final BukuKasUmum bku, final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/indexbkubos", "refbku", bku);
    }

    @RequestMapping(value = "/sudinbkubos", method = RequestMethod.GET)
    public ModelAndView indexsudin(final BukuKasUmum bku, final HttpServletRequest request) {
        final Pengguna pengguna = (Pengguna) request.getSession().getAttribute("pengguna");

        return new ModelAndView("bkubos/sudinbkubos", "refbku", bku);
    }

    @RequestMapping(value = "/addbkubos", method = RequestMethod.GET)
    public ModelAndView addbku(final BukuKasUmum bku, final HttpServletRequest request) {
        final Pengguna pengguna = (Pengguna) request.getSession().getAttribute("pengguna");

        return new ModelAndView("bkubos/addbkubos", "refbku", bku);
    }
    ...
    String prosessimpanbku(@RequestBody Map<String, Object> mapdata, final HttpServletRequest request) {
        ...
        final String kodesaldo = (String) mapdata.get("kodesaldo");

        bukukas.setKodeSaldoAwal(kodesaldo);
    ...
    public ModelAndView editbkuc12(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubosc12", "refbku", bku);
    }
    ...
    public ModelAndView editbkujo(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubosjo", "refbku", bku);
    }
    ...
    public ModelAndView editbkurt(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubosrt", "refbku", bku);
    }
    ...
    public ModelAndView editbkujg(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubosjg", "refbku", bku);
    }
    ...
    public ModelAndView editbkuspj(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubosspj", "refbku", bku);
    }
    ...
    public ModelAndView editbkupajak(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubospajak", "refbku", bku);
    }
    ...
    public ModelAndView editbkusetor(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubosst", "refbku", bku);
    }
    ...
    public ModelAndView hapusbkuc12(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/deletebkubosc12", "refbku", bku);
    }
    ...
    public ModelAndView hapusbkujo(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/deletebkubosjo", "refbku", bku);
    }
    ...
    public ModelAndView hapusbkurt(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/deletebkubosrt", "refbku", bku);
    }
    ...
    public ModelAndView hapusbkujg(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/deletebkubosjg", "refbku", bku);
    }
    ...
    public ModelAndView hapusbkusetor(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/deletebkubosst", "refbku", bku);
    }
    ...
    public ModelAndView hapusbkuspj(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/deletebkubosspj", "refbku", bku);
    }
    ...
    public ModelAndView hapusbkupajak(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/deletebkubospajak", "refbku", bku);
    }
    ...
    public ModelAndView listsetoran(final BukuKasUmum bku, final HttpServletRequest request, final HttpServletResponse response) {
        ...
        return new ModelAndView("bkubos/listsetoran", "refkegiatan", bku);
    }
    ...
    Map<String, Object> getSaldoAwal(final HttpServletRequest request) {
        ...
        log.debug("SALDO AWAL " + bkuServices.getSaldoAwal(param));
        return mapData;
    }
    ...
    public ModelAndView listpjpn(final BukuKasUmum bku, final HttpServletRequest request, final HttpServletResponse response) {
        response.setHeader("X-FRAME-OPTIONS", "SAMEORIGIN");
        return new ModelAndView("bkubos/listspjrinci", "refkegiatan", bku);
    }
    ...
    public ModelAndView listpjpg(final BukuKasUmum bku, final HttpServletRequest request, final HttpServletResponse response) {
        response.setHeader("X-FRAME-OPTIONS", "SAMEORIGIN");
        return new ModelAndView("bkubos/listspnpajak", "refkegiatan", bku);
    }
    ...
    public ModelAndView arsipbkujo(final HttpServletRequest request) {
        ...
        return new ModelAndView("arsipbkubos/arsipbkubosjo", "refbku", bku);
    }
    ...
    public ModelAndView arsipbkurt(final HttpServletRequest request) {
        ...
        return new ModelAndView("arsipbkubos/arsipbkubosrt", "refbku", bku);
    }

    @RequestMapping(value = "/arsipbkuc12/", method = RequestMethod.GET)
    public ModelAndView arsipbku12(final HttpServletRequest request) {
        final Pengguna pengguna = (Pengguna) request.getSession().getAttribute("pengguna");
        final String tahun = request.getParameter("tahun");
        final String idbku = request.getParameter("idbku");
    ...
    public ModelAndView arsipbkujg(final HttpServletRequest request) {
        ...
        return new ModelAndView("arsipbkubos/arsipbkubosjg", "refbku", bku);
    }
    ...
    public ModelAndView arsipbkuspj(final HttpServletRequest request) {
        ...
        return new ModelAndView("arsipbkubos/arsipbkubosspj", "refbku", bku);
    }
    ...
    public ModelAndView arsipbkupajak(final HttpServletRequest request) {
        ...
        return new ModelAndView("arsipbkubos/arsipbkubospajak", "refbku", bku);
    }
    ...
    public ModelAndView arsipbkust(final HttpServletRequest request) {
        ...
        return new ModelAndView("arsipbkubos/arsipbkubosst", "refbku", bku);
    }
    ...
    public ModelAndView listjgpn(final BukuKasUmum bku, final HttpServletRequest request, final HttpServletResponse response) {
        response.setHeader("X-FRAME-OPTIONS", "SAMEORIGIN");
        return new ModelAndView("bkubos/listpnjasagiro", "refkegiatan", bku);
    }
    ...
    public ModelAndView editbkuspjbukti(final HttpServletRequest request) {
        ...
        return new ModelAndView("bkubos/editbkubosspjbukti", "refbku", bku);
    }
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException {
        ...
        map.put("pathreport", pathReport + "/Report_Bukti_Transaksi_bos.jasper");
        map.put("filename", tahunAnggaran + "-" + "Bukti-Transaksi-" + idbku + idsekolah + ".pdf");
    ...
    public void prosescetakbpn(HttpServletRequest request, HttpServletResponse response) throws SQLException {
        ...
        String filename = "BuktiPenerimaanNegaraBOS_" + tahun + "_" + idsekolah + "_" + idbku + "_" + kodetrx + ".pdf";

        map.put("pathreport", pathReport + "/Report_BuktiPenerimaanNegara_BOS.jasper");
        map.put("filename", filename);

        printReportToPdfStream(response, map);
    }

    @RequestMapping(value = "/json/getCountSaldoAwal", method = RequestMethod.GET)
    public @ResponseBody
    Integer getCountSaldoAwal(final HttpServletRequest request) {
        final String tahunAnggaran = (String) request.getSession().getAttribute("tahunAnggaran");
        final String idsekolah = request.getParameter("idsekolah");
        ...
        return bkuServices.getCountSaldoAwal(param);
    }
