...
import ebkus.services.KoreksiAkunBopServices;
 ...
 */
@Controller
@RequestMapping("/koreksiakunbop")
public class KoreksiAkunBopAction extends PrintReportTemplate {

    private static final Logger log = LoggerFactory.getLogger(KoreksiAkunBopAction.class);

    @Autowired
    KoreksiAkunBopServices bkuServices;
    ...
    public ModelAndView index(final BukuKasUmum bku, final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbop/indexkoreksibop", "refbku", bku);
    }
    ...
    public ModelAndView addkoreksi(BukuKasUmum bku, @PathVariable String idsekolah, final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbop/addkoreksibop", "refbku", bku);
    }
    ...
    Integer getMaxTriwulan(final HttpServletRequest request) {
        ...
        return bkuServices.getMaxTriwulanByRekap(param);
    }
    ...
    public ModelAndView listsetoran(final BukuKasUmum bku, final HttpServletRequest request, final HttpServletResponse response) {
        ...
        return new ModelAndView("koreksiakunbop/listspj", "refkegiatan", bku);
    }
    ...
    public ModelAndView editbkuspj(final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbop/editkoreksibop", "refbku", bku);
    }
    ...
    public ModelAndView arsipkoreksi(final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbop/arsipkoreksibop", "refbku", bku);
    }
