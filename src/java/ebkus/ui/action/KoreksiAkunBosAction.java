...
import ebkus.services.KoreksiAkunBosServices;
 ...
 */
@Controller
@RequestMapping("/koreksiakunbos")
public class KoreksiAkunBosAction extends PrintReportTemplate {

    private static final Logger log = LoggerFactory.getLogger(KoreksiAkunBosAction.class);

    @Autowired
    KoreksiAkunBosServices bkuServices;
    ...
    public ModelAndView index(final BukuKasUmum bku, final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbos/indexkoreksibos", "refbku", bku);
    }
    ...
    public ModelAndView addkoreksi(BukuKasUmum bku, @PathVariable String idsekolah, final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbos/addkoreksibos", "refbku", bku);
    }
    ...
    public ModelAndView listsetoran(final BukuKasUmum bku, final HttpServletRequest request, final HttpServletResponse response) {
        ...
        return new ModelAndView("koreksiakunbos/listspj", "refkegiatan", bku);
    }
    ...
    public ModelAndView editbkuspj(final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbos/editkoreksibos", "refbku", bku);
    }
    ...
    public ModelAndView arsipkoreksi(final HttpServletRequest request) {
        ...
        return new ModelAndView("koreksiakunbos/arsipkoreksibos", "refbku", bku);
    }
