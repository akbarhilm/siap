...
import ebkus.services.MonitoringBkuBosTransferServices;
 ...
 */
@Controller
@RequestMapping("/monbos")
public class MonitoringBkuBosTransferAction extends PrintReportTemplate {

    private static final Logger log = LoggerFactory.getLogger(MonitoringBkuBosTransferAction.class);
    @Autowired
    ...
    @Autowired
    MonitoringBkuBosTransferServices bkuBosTransferServices;
    ...
    public ModelAndView index(final BukuKasUmum bku, final HttpServletRequest request) {
        ...
        return new ModelAndView("monitoring/indexmonitoringbkubostransfer", "refmonbkubos", bku);
    }
    ...
    Map<String, Object> listindex(final HttpServletRequest request) {
        ...
        final long banyak = bkuBosTransferServices.getBanyakListIndex(param);
        mapData.put("sEcho", request.getParameter("sEcho"));
        mapData.put("iTotalRecords", banyak);
        mapData.put("iTotalDisplayRecords", banyak);
        mapData.put("aaData", bkuBosTransferServices.getListIndex(param));
    ...
    Map<String, Object> getTotal(final HttpServletRequest request) {
        ...
        final Map<String, Object> mapData = new HashMap<String, Object>(4);
        mapData.put("aData", bkuBosTransferServices.getNilaiIndex(param));
        return mapData;
    }
    ...
    Map<String, Object> getSaldo(final HttpServletRequest request) {
        ...
        final Map<String, Object> mapData = new HashMap<String, Object>(4);
        mapData.put("aData", bkuBosTransferServices.getNilaiSaldo(param));
        return mapData;
    }
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException {
        ...
        map.put("pathreport", pathReport + "/Report_Monitoring_Transfer_Keg_Bku_Bos_Triwulan.jasper");
        map.put("filename", tahunAnggaran + "-" + "Laporan_Monitoring_Transfer_Keg_Bku_Bos_Triwulan_" + tw + ".pdf");
