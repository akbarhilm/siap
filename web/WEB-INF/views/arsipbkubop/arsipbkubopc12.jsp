...
<ul class="breadcrumb">
    ...
    <li><a href="#">Arsip C1 atau C2</a></li>
    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglDok" id="tglDok"  class="required  date-picker entrytanggal valid" size="14" readonly="true" value="" />
            ...
            <div id="labelfileinbox" name="labelfileinbox" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="inboxFile" id="inboxFile" type="text"  class="required "  size="14" maxlength="10" readonly="true" />
                    <form:errors path="inboxFile" class="error" />
                </div>
            </div>

            <div id="labelnippptk" name="labelnippptk" class="form-group">
                <label id="textNipPptk" class="col-md-3 control-label">Nilai:</label>
                <div class="col-md-4">
                    <input name="nilai" id="nilai" type="text" onchange="setformatpengeluaran(this.value)" readonly="true" />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubos/editbkubopc12.js"></script>
