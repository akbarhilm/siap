...
<ul class="breadcrumb">
    ...
    <li><a href="#">Arsip Jasa Giro</a></li>
    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelnilaijg" name="labelnilaijg" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="nilaijg" id="nilaijg" type="text" readonly="true" onchange="setformatpengeluaran(this.value)" /> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/deletebkubopjg.js"></script>  
