    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelcarabayar" name="labelcarabayar" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="kodePembayaran" id="kodePembayaran" onchange="" disabled="true">
            ...
            <div id="labelnilaijg" name="labelnilaijg" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="nilaijg" id="nilaijg" type="text" readonly="true" onchange="setformatpengeluaran(this.value)" /> &nbsp <a  class="fancybox fancybox.iframe btn green" id="pilihjg"  href="${pageContext.request.contextPath}/bkubop/listsetoran?target='_top'" title="Pilih Data Setoran"  ><i class="icon-zoom-in"></i> Pilih</a> 
            ...
            <div id="labelnrk" name="labelnrk" class="form-group">
                <label id="textNipPptk" class="col-md-3 control-label">NIR PPTK :</label>
                <div class="col-md-4">
                    <form:input path="nrkPptk" id="nrkPptk" type="text" readonly="true" class="required "  maxlength="6"/> 
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/editbkubopst.js"></script>  
