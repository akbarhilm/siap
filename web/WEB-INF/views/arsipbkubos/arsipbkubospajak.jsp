    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group" id="labelrumuspajakp1">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select  id="rumuspajakp1" disabled="true" >
                            <option value="-">Pilih</option>
                            <option value="1">NPWP</option>
                            <option value="2">NON NPWP</option>
                        </select>

                        <select  id="rumuspersenp1" disabled="true" >
            ...
            <div class="form-group" id="labelrumuspajakp2">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select  id="rumuspajakp2" disabled="true" >
                            <option value="-">Pilih</option>
            ...
            <div class="form-group" id="labelrumuspajakp3">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select  id="rumuspajakp3" disabled="true" >
                            <option value="-">Pilih</option>
                            <option value="0">NON PPN</option>
                            <option value="1">PPN</option>
                        </select>

                        <select  id="rumuspersenp3" disabled="true" >
            ...
            <div class="form-group" id="labelrumuspajakp5">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select  id="rumuspajakp5" disabled="true" >
                            <option value="-">Pilih</option>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubos/editbkubospajak.js"></script>
