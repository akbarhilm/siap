    ...
    <div class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group" >
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="tanggal" readonly="true" onchange="setNoBa()" type="text" name="tanggal" id="tanggal" size="14" />
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <form:textarea path="uraian" readonly="true" class="required" name="uraian" id="uraian" cols="80" ROWS="3" maxlength="400"/>
                </div>
            </div>
            <div id="divButton" class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9" align="Right">
                    <button type="button" id="btnSimpan" class="btn blue" onclick='cetak()'>Cetak</button>
                </div>
            </div>
        </div>
    </div>
