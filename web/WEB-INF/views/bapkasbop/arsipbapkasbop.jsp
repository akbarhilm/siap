    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <input type="hidden" id="arsip" name="arsip" value="1" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangKertas"  id="nilaiUangKertas1" readonly="true"  onchange="setformatKertas(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right"  />&nbsp;&nbsp;&nbsp;(1)
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangLogam"  id="nilaiUangLogam1" readonly="true"  onchange="setformatLogam(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right"  />&nbsp;&nbsp;&nbsp;(2)
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangSp2d"  id="nilaiUangSp2d1" readonly="true"  onchange="setformatSp2d(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right"  />&nbsp;&nbsp;&nbsp;(3)
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangSaldoBank"  id="nilaiUangSaldoBank1" readonly="true"   onchange="setformatSaldoBank(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right"  />&nbsp;&nbsp;&nbsp;(4)
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangSuratBerharga"  id="nilaiUangSuratBerharga1" readonly="true"  onchange="setformatSuratBerharga(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right"  />&nbsp;&nbsp;&nbsp;(5)
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangSaldoBkuBa"  id="nilaiUangSaldoBkuBa" readonly="true"  onchange="setformatSaldoBkuBa(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right"  />
                    </div>
                </div>
            </div>
            <div class="form-group">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bapkasbop/editbapkasbop.js"></script>
