...
<form:form   method="post" commandName="refsppup"  id="refsppup" onsubmit="return simpan()"  action="${pageContext.request.contextPath}/bapkasbop/prosesubah" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input type="hidden" id="arsip" name="arsip" value="0" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input name="tw" id="tw" type="text" size="15" disabled="true"/>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangSaldoBkuBa"  id="nilaiUangSaldoBkuBa" readonly="true" onkeyup="getNilaiTotalSelisihBAPKas(),cektotalbk()" onchange="setformatSaldoBkuBa(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right"  />  &nbsp;(7)
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangSelisihBkuBa"  id="nilaiUangSelisihBkuBa" onchange="setformatSaldoBkuBa(this.value)"   size="19" onkeypress="return isNumber(event)" style="text-align:right" readonly="true"  />   &nbsp;&nbsp;&nbsp; (8=6-7)
                    </div>
                </div>
            </div>
