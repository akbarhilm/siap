...
<form:form   method="post" commandName="refsppup"  id="refsppup"  onsubmit="return simpan()" action="${pageContext.request.contextPath}/bapkasbos/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Input Berita Acara Pemerikasaan (BAP) Kas - BOS</div>
        </div>
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type='hidden'  value="${sekolah.noBOS}" id='rekeningBOS'>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  type="text"  path="nilaiUangSaldoBkuBa"  id="nilaiUangSaldoBkuBa" readonly="true" value="0" size="21" onkeyup="getNilaiTotalSelisihBAPKas(),cektotalbk()"  style="text-align:right" /> &nbsp; (7)
                    </div>
                </div>
            </div>
    ...
    <div class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Rincian Berita Acara Pemerikasaan (BAP) Kas - BOS</div>
        </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bapkasbos/addbapkasbos.js"></script>
