...
<div class="portlet box tosca">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar  Berita Acara Pemeriksaan Kas - BOS</div>
        <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bapkasbos/indexbapkasbos.js"></script>
