        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-actions fluid" id="panelTombol">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a id="btnproses" value="1" onclick="setProsesTutup()" class="fancybox fancybox.iframe btn blue" href="${pageContext.request.contextPath}/bataltutupbkubos/panelsimpanpop?target='_top'" title="Tutup BKU Pengeluaran"  ></i>Batal Tutup BKU</a>
                </div>
            </div>
        </div>
    </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bataltutupbku/indextutupbkubos.js"></script>
