...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/bataltutupbku/prosestidakterpakai" class="form-horizontal">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bataltutupbku/panelsimpanpopbos.js"></script>
