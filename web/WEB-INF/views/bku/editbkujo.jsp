...
<ul class="breadcrumb">
    ...
    <li><a href="#">Pengisian Kas Sekolah</a></li>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelsumbdana" class="form-group">
                <label class="col-md-3 control-label">Sumber Dana :</label>
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="kodeSumbdana" id="kodeSumbdana" onchange="cekGantiKode(this.value)">
                            <form:option value="1">1 - BOS</form:option> 
                            <form:option value="2">2 - BOP</form:option>
                        </form:select>
                    </div>
                </div> 
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkujo.js"></script>  
