...
<ul class="breadcrumb">
    ...
    <li><a href="#">Pengeluaran Pajak</a></li>
        ...
        <div class="portlet-body flip-scroll">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input type="hidden" id="idKegpop" name="idKegpop"  onchange="" value="">
            ...
            <div id="labelkegiatanspj" class="form-group">
                ...
                <div class="col-md-9">
                    <form:input type="text" path="ketKegiatan"  id="ketKegiatan"  class="m-wrap large" size="80" readOnly="true"/>  &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKegPj" onclick="" href="${pageContext.request.contextPath}/bku/listkegpajakpn?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> 
                    <form:hidden path="idKegiatan" id='idKegiatan'  />
                    <form:hidden id="kodeKeg" path="kodeKeg"  value="" />
                    <form:hidden path="noBkuRef" id='noBkuRef' onchange="setKegiatan()" />
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkupjpg.js"></script>  
