        ...
        <div class="portlet-body flip-scroll">
            <div class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input type="hidden" id="idbastemp" name="totalspjhidden"  />
                    <input type="hidden" id="indextemp" name="totalpajakhidden"  />
            ...
            <div id="labelsumbdanaspj" name="labelsumbdanaspj" class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <form:hidden id="kodeSumbdana" path="kodeSumbdana"  />
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkuspj.js"></script>  
