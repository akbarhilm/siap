...
<ul class="breadcrumb">
    ...
    <li><a href="#">Setoran Kas Sekolah</a></li>
    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelsumbdana" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="kodeSumbdana" id="kodeSumbdana" onchange="getSisaKas()">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">Nilai Sisa Kas:</label>
                <div class="col-md-4">
            ...
            <div id="labelnippptk" name="labelnippptk" class="form-group">
                <label id="textNipPptk" class="col-md-3 control-label">Nilai Setor:</label>
                <div class="col-md-4">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/editbkust.js"></script>  
