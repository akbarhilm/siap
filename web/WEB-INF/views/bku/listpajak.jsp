...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bku/listpajak.js"></script>    

<script type="text/javascript">
    $(document).ready(function() {

        ketbaris = $('#indextemp', window.parent.document).val(); //window.localStorage.getItem("ketBaris");
        ketidbas = $('#idbastemp', window.parent.document).val(); 
