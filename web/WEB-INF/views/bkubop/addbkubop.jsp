...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/bkubop/indexbkubop" >Buku Kas Umum Sekolah - BOP </a>
        <span class="icon-angle-right"></span>
    </li>
    <li><a href="#">Input Buku Kas Umum Sekolah - BOP</a></li>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Buku Kas Umum Sekolah - BOP</div>
        ...
        <div class="portlet-body flip-scroll">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select path="kodeTransaksi" id="kodeTransaksi" onchange="setPanel(), setRumusPajak()">
                            ...
                            <option value="ST">SETOR SISA KAS </op tion>
            ...
            <div class="form-group" id="labeltgldok">
                ...
                <label id="labeltglbukti" class="col-md-3 control-label">Tanggal Pengajuan :</label>
                <div class="col-md-4">
                    <div class="input-group">
            ...
            <div id="labelbidang" name="labelbidang" class="form-group">
                <label id="textlabelbidang" class="col-md-3 control-label">Bidang :</label>
                <div class="col-md-4">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/addbkubop.js"></script>
