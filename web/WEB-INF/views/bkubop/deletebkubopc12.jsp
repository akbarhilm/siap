...
<ul class="breadcrumb">
    ...
    <li><a href="#">Hapus C1 atau C2</a></li>
    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:select path="kodeTransaksi" id="kodeTransaksi" disabled="true" readonly="true" >
                            ...
                            <form:option value="C1">PENCAIRAN CEK</form:option>
                            <form:option value="C2">SETOR TUNAI</form:option>
            ...
            <div id="labelnippptk" name="labelnippptk" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="nilai" id="nilai" type="text" onchange="setformatpengeluaran(this.value)" />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/editbkubopc12.js"></script>
