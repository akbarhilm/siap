...
<ul class="breadcrumb">
    ...
    <li><a href="#">Hapus Pendapatan Lain-Lain</a></li>
    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group" id="nobuktiketerangan">
                        <form:input path="noBukti" id="noBukti" type="text" size="32" readonly="true"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglDok" id="tglDok" readonly="true" class="required  date-picker2 entrytanggal2 valid" size="14" />
            ...
            <div id="labelfileinbox" name="labelfileinbox" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="inboxFile" id="inboxFile" type="text"  class="required " readonly="true" size="14" maxlength="10" />
            ...
            <div id="labelnilaijg" name="labelnilaijg" class="form-group">
                <label id="labelpengeluarantext" class="col-md-3 control-label">Nilai :</label>
                <div class="col-md-4">
                    <input name="nilaijg" id="nilaijg" type="text" readonly="true" /> 
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/editbkuboprt.js"></script>
