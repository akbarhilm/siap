    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelnilaijg" name="labelnilaijg" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="nilaijg" id="nilaijg" type="text" onchange="setformatpengeluaran(this.value)" /> &nbsp <a  class="fancybox fancybox.iframe btn green" id="pilihjg"  href="${pageContext.request.contextPath}/bkubop/listjgpn?target='_top'" title="Pilih Data Setoran"  ><i class="icon-zoom-in"></i> Pilih</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/editbkubopjg.js"></script>
