    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelbidang" name="labelbidang" class="form-group">
                <label id="" class="col-md-3 control-label">Bidang :</label>
                <div class="col-md-4">
            ...
            <div id="labelrekbank" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="norekBank" id="norekBank" type="text" size="50" class="required " maxlength="30" onkeypress="return isNumber(event)"/>
                    </div>
                </div>
            </div>
            ...
            <div id="labelnamarekanan" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="namaRekan" id="namaRekan" type="text"  class="required " size="50" maxlength="50" onkeypress="return isNamaRekanan(event)" />
                    </div>
                </div>
            </div>
            ...
            <div id="labelnpwp" name="labelnpwp" class="form-group">
                <label id="textnpwp" class="col-md-3 control-label"><i class="icon-info-sign" title="Wajib Diisi Jika Rekanan Memiliki NPWP dan Dipotong Pajak."></i> NPWP Rekanan/PFK :</label>
                <div class="col-md-4">
                    <form:hidden path="npwp" id='datanpwp' />
                    <input name="npwp" id="npwp" type="text" maxlength="30" onchange="getDataNPWP()" maxlength="15" onkeypress="return isNumber(event)" />
                </div>
            </div>
            <div id="labelnamanpwp" name="labelnamanpwp" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="namaNpwp" id="namanpwp" type="text" size="50" class="required "  maxlength="100" readonly="true"/>
                </div>
            </div>
            ...
            <div id="labelkotanpwp" name="labelkotanpwp" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="kotaNpwp" id="kotanpwp" type="text" size="50" class="required "  maxlength="100" readonly="true"/>
                </div>
            </div>
            ...
            <div id="labelsk" class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group">
                        ...
                        &nbsp;
                        <input name="kodesk" id="kodesk" type="text" maxlength="100" />
                    </div>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/editbkubopspj.js"></script>
