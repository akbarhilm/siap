...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/listsetoran.js"></script>    
...
<script type="text/javascript">
    ...
    function ambildata(id) {
        console.log("no bku ref : "+$("#nobkuref" + id).val());
        
        $('#noBuktiDok', window.parent.document).val($("#nosts" + id).val()).change();
        $('#nilaijg', window.parent.document).val($("#nilai" + id).val()).change();
        $('#tglDok', window.parent.document).val($("#tanggal" + id).val()).change();
        $('#nobkuref', window.parent.document).val($("#nobkuref" + id).val()).change();
        
        // untuk edit
        $('#noBukti', window.parent.document).val($("#nosts" + id).val()).change();
        $('#noBkuRef', window.parent.document).val($("#nobkuref" + id).val()).change();
