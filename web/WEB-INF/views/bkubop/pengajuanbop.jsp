...
<ul class="breadcrumb">
    ...
    <li><a href="#">Pengajuan Belanja BKU - BOP</a></li>
</ul>

<form:form   method="post" commandName="pengajuanbop"  id="pengajuanbop"   action="${pageContext.request.contextPath}/" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pengajuan Belanja BKU - BOP</div>
        </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/pengajuanbop.js"></script>
