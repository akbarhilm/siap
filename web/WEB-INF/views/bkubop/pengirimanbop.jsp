...
<ul class="breadcrumb">
    ...
    <li><a href="#">Pengajuan Pembayaran Ke Sudin</a></li>
</ul>

<form:form   method="post" commandName="pengirimanbop"  id="pengirimanbop"   action="${pageContext.request.contextPath}/" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pengajuan Pembayaran Ke Sudin</div>
        </div>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <!--            <div id="belumPengajuan" class="form-group">
                            <label class="col-md-3 control-label">Jumlah Yang Belum Melakukan Pengajuan :</label>
                            <div class="col-md-4">
                                <input id="belum" type="text" size="6" maxlength="4" readonly='true' />
                            </div>
                        </div>
                        <div id="sudahPengajuan" class="form-group">
                            <label class="col-md-3 control-label">Jumlah Yang Sudah Melakukan Pengajuan :</label>
                            <div class="col-md-4">
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <!--<input type="hidden" id="approve" name="sudin"  />-->
                    <!--<button id="ajukan"  type="button"  class="btn blue" onclick="prosesAjukan()"> Ajukan </button>-->
                    <button id="kirim"  type="button"  class="btn blue" onclick="prosesKirim()"> Proses </button>
                    <button id="cetak"  type="button"  class="btn blue" onclick="prosesCetak()"> Cetak </button>
                    <!--<button id="undo"  type="button"  class="btn blue" onclick="prosesBatalkan()"> Batalkan </button>-->
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/pengirimanbop.js"></script>
