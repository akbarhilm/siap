...
<ul class="breadcrumb">
    ...
    <li><a href="#">Persetujuan Belanja BKU - BOP</a></li>
</ul>

<form:form   method="post" commandName="persetujuanbop"  id="persetujuanbop"   action="${pageContext.request.contextPath}/" class="form-horizontal">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <button id="setujui"  type="button"  class="btn blue" onclick="buttonCheck()"> Setujui </button>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubop/persetujuanbop.js"></script>
