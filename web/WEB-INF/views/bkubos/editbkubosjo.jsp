...
<ul class="breadcrumb">
    ...
    <li><a href="#">Ubah Pengisian Kas Sekolah</a></li>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelcbsaldo" name="labelcbsaldo" class="form-group">
                ...
                <div class="col-md-4">
                    ...
                    <input type="checkbox" id="cbSaldoAwal" id="cbSaldoAwal" onchange="setSaldoAwal()"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglDok" id="tglDok"  class="required  date-picker entrytanggal valid" size="14" value="" />
            ...
            <div id="labelnippptk" name="labelnippptk" class="form-group">
                ...
                <div class="col-md-4">
                    <input name="saldokas" id="saldokas" type="text" onchange="setformatpengeluaran(this.value)" />
