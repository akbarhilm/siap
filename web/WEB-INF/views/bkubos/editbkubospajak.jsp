    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input path="npwp" onchange="getDataNPWP()" id="npwp" type="text"  onkeypress="return isNumber(event)" class="required " maxlength="15" readonly="true"/>
                    </div>
                </div>
            </div>
            <div id="labelnamanpwp" name="labelnamanpwp" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="namaNpwp" name="namanpwp" id="namanpwp" size="50" type="text" maxlength="100" readonly="true" />
                </div>
            </div>
            ...
            <div id="labelkotanpwp" name="labelkotanpwp" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="kotaNpwp" name="kotanpwp" id="kotanpwp" size="50" type="text" maxlength="100" readonly="true" />
                </div>
            </div>
