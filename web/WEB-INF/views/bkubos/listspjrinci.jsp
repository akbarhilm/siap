...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubos/listspjrinci.js"></script>

<script type="text/javascript">
    $(document).ready(function() {
        triwulan = $('#triwulan', window.parent.document).val();
        jenisbayarpajak = $('#jenisBayarPajak', window.parent.document).val();
...
<form:form   method="post" commandName="refkegiatan"  id="refkegiatan"   action="" class="form-horizontal">
    <div class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Daftar SPJ Rinci</div>
        </div>
