...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubos/listspnpajak.js"></script>
...
<script type="text/javascript">
    ...
    function ambildata(id) {
        ...
        $('#npwp', window.parent.document).val($("#npwp" + id).val()).change();
//        parent.getWpPjPg();
