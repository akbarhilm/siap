...
<ul class="breadcrumb">
    ...
    <li><a href="#">Persetujuan Belanja BKU - BOS</a></li>
</ul>

<form:form   method="post" commandName="persetujuanbos"  id="persetujuanbos"   action="${pageContext.request.contextPath}/" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Persetujuan Pembayaran BKU - BOS</div>
        </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubos/persetujuanbos.js"></script>
