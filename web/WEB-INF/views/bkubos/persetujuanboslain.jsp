...
<ul class="breadcrumb">
    ...
    <li><a href="#">Persetujuan Pembayaran BKU - BOS</a></li>
</ul>

<form:form   method="post" commandName="persetujuanboslain"  id="persetujuanboslain"   action="${pageContext.request.contextPath}/" class="form-horizontal">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubos/persetujuanboslain.js"></script>
