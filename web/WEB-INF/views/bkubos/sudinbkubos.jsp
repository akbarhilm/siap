...
<ul class="breadcrumb">
    ...
    <li><a href="#">Buku Kas Umum Sekolah - BOS</a></li>
</ul>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title"> <!-- cogs-->
            <div class="caption"><i class="icon-cogs"></i>Entry Buku Kas Umum Sekolah - BOS</div>
            <div class="actions">
                <a onclick="" href="${pageContext.request.contextPath}/bkubos/addbkubos"  class="btn dark"  ><i class="icon-plus"></i> Tambah</a>
            </div>
        </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkubos/sudinbkubos.js"></script>
