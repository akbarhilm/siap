...
<ul class="breadcrumb">
    ...
    <li><a href="#">Input Batas Waktu Pengajuan Belanja Sekolah</a></li>
    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select path="kodeSumbdana" id="kodeSumbdana" >
                            <option value="1">BOS</option>
                            <option value="2" selected>BOP</option>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/bkuproses/addbkuproses.js"></script>
