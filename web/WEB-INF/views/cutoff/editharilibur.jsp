...
<form:form   method="post" commandName="refbku"  id="refbku"   action="" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labeluraian" name="labeluraian" class="form-group">
                ...
                <div class="col-md-4">
                    <form:textarea path="keterangan" id="keterangan" class="required " cols="80" ROWS="3" maxlength="400" />
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="form-actions fluid">
        <div class="col-md-offset-3 col-md-9" >
            <button type="button" id="btnUbah" class="btn blue" onclick='cekSimpan(2)'>Ubah</button>
