...
<ul class="breadcrumb">
    ...
    <li><a href="#">Laporan BKU BOP</a></li>
</ul>
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <select  id="jenislap"  onchange="setPanelAkun()">
                            ...
                            <option value="11" >Form : Laporan Daftar Kegiatan Sekolah</option>
                            <option value="12" >Form : Laporan Pengajuan Dana Sekolah</option>
                            <option value="13" >Form : Laporan Realisai Penerimaan Penyetoran Sekolah</option>
