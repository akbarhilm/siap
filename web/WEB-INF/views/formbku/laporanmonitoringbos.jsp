...
<ul class="breadcrumb">
    ...
    <li><a href="#">Laporan Monitoring BOS</a></li>
</ul>
...
<form:form   method="post" commandName="refcetak"  id="refcetak"   action="${pageContext.request.contextPath}/laporanlra/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Laporan Monitoring BOS</div>
        </div>
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <select  id="jenislap"  onchange="setPanelAkun()">
                            ...
                            <option value="1" >Rincian Pengajuan Pembayaran Anggaran BOS</option>
                            <option value="2" >Buku Pembantu Rincian Objek</option>
                            <option value="3" >Laporan BOS Per Triwulan</option>
                            <option value="4" >Report Rekap BOS</option>
                            <option value="5" >Report Monitoring Transaksi Belanja BOS</option>
                            <option value="6" >Report Monitoring Transfer BOS</option>
                            ...
                            <option value="10" >Report Realisasi Kegiatan SKPD-BOS</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/formbku/laporanmonitoringbos.js"></script>
