            ...
            <div class="form-horizontal" >
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                             <input type="text" id="tgl"   size="14"  value="" />
                    ...
                    <div class="form-actions fluid">
                        <div class="col-md-offset-3 col-md-9">
                            <a hre="#" id='tmp' class='btn blue' onclick="getRekKor()">Proses</a>
            ...
            <table id="usertable" class="table table-striped table-bordered table-condensed table-hover " >
                ...
                <tfoot>
                    <tr>
                        ...
                        <th >
                            <input type='text' id="sumterima"   name="sumterima" readonly="true"  class="inputmoney"  style='border:none;margin:0;width:100%;'    />
                        </th>

                        <th >
                            <input type='text' id="sumkeluar"   name="sumkeluar" readonly="true"  class="inputmoney"  style='border:none;margin:0;width:100%;'    />
                        </th>
                    </tr>
