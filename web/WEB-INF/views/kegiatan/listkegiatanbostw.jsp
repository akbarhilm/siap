...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/kegiatan/listkegiatanbostw.js"></script>
...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        ...
        //untuk edit
        $('#ketKegiatan', window.parent.document).val($("#ket" + id).val()).change();
        $('#kodeKeg', window.parent.document).val($("#kode" + id).val()).change();
