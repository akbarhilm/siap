...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/koreksiakunbop/index" >Koreksi - BOP </a>
        <span class="icon-angle-right"></span>
    </li>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Koreksi Kode Akun - BOP</div>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelkegiatanpajak" class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <a  class="fancybox fancybox.iframe btn green" id="pilihKegiatan" onclick="" href="${pageContext.request.contextPath}/koreksiakunbop/listpj?target='_top'" title="Pilih Kegiatan" ><i class="icon-zoom-in"></i> Pilih</a>
    ...
    <div class="form-actions fluid">
        <div id="divButton" class="col-md-offset-3 col-md-9" align="Right">
            ...
            <a class="btn blue"  href="${pageContext.request.contextPath}/koreksiakunbop/index" >Kembali</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksiakunbop/addkoreksibop.js"></script>
