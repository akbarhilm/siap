    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group" id="nobuktiketerangan">
                        <form:input path="noBukti" id="noBuktiDok" type="text" maxlength="50" />
                    </div>
                </div>
            </div>
            ...
            <div id="labelnrk" name="labelnrk" class="form-group">
                <label id="textNrkPptk" class="col-md-3 control-label">NRK Pengoreksi :</label>
                <div class="col-md-4">
            ...
            <div id="labeluraian" name="labeluraian" class="form-group">
                ...
                <div class="col-md-4">
                    <form:textarea path="uraianBukti" id="uraian" class="required " cols="80" ROWS="3" maxlength="100" />
                </div>
            </div>
