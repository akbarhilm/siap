...
<ul class="breadcrumb">
    ...
    <li><a href="#">Koreksi Kode Rekening Belanja</a></li>
</ul>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="" class="form-horizontal">
    ...
    <div class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Koreksi Kode Rekening Belanja</div>
            <div class="actions">
        ...
        <div class="portlet-body flip-scroll">
            <form class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            <form:hidden path="sekolah.idSekolah" id='idsekolah' value="${sekolah.idSekolah}" name="idsekolah" onchange='getMaxTriwulan(), setTw()' />
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksiakunbos/indexkoreksibos.js"></script>
