...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksiakunbos/listspj.js"></script>
...
<script type="text/javascript">
    ...
    function ambildata(id) {
        $('#noBkuMohon', window.parent.document).val($("#nobku" + id).val()).change();
