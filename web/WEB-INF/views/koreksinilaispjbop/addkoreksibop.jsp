...
<ul class="breadcrumb">
    ...
    <li><a href="#">Input Koreksi - BOP</a></li>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labelkegiatanpajak" class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <a  class="fancybox fancybox.iframe btn green" id="pilihKegiatan" onclick="" href="${pageContext.request.contextPath}/koreksinilaispjbop/listpj?target='_top'" title="Pilih Kegiatan" ><i class="icon-zoom-in"></i> Pilih</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksinilaispjbop/addkoreksibop.js"></script>
