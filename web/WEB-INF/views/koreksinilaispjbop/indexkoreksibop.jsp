...
<ul class="breadcrumb">
    ...
    <li><a href="#">Koreksi Nilai Belanja - BOP</a></li>
</ul>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksinilaispjbop/indexkoreksibop.js"></script>
