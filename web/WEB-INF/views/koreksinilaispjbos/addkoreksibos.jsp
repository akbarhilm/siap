...
<ul class="breadcrumb">
    ...
    <li>
        <a href="${pageContext.request.contextPath}/koreksinilaispjbos/index" >Koreksi - BOS </a>
        <span class="icon-angle-right"></span>
    </li>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labeltriwulan" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="hidden" id="triwulanKoreksi" name="triwulanKoreksi">
            ...
            <div id="labelkegiatanpajak" class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <a  class="fancybox fancybox.iframe btn green" id="pilihKegiatan" onclick="" href="${pageContext.request.contextPath}/koreksinilaispjbos/listpj?target='_top'" title="Pilih Kegiatan" ><i class="icon-zoom-in"></i> Pilih</a>
            ...
            <div class="form-group">
                ...
                <div class="col-md-9">
                    <div class="input-group" id="nobuktiketerangan">
                        ...
                        <input name="noBkuRef" id="noBkuRef" type="text"  readonly="true" size="14" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group" id="labeltglpost">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text" name="tglPost" id="tglPost" class="required date-picker2 entrytanggal valid" size="14" value=""/>
            ...
            <div class="form-group" id="labeltgldok">
                <label id="labeltgl" class="col-md-3 control-label">Tanggal Pengajuan :</label>
                <div class="col-md-4">
                    <div class="input-group">
    ...
    <div class="form-actions fluid">
        <div id="divButton" class="col-md-offset-3 col-md-9" align="Right">
            ...
            <a class="btn blue"  href="${pageContext.request.contextPath}/koreksinilaispjbos/index" >Kembali</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksinilaispjbos/addkoreksibos.js"></script>
