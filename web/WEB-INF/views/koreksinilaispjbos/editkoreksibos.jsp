...
<ul class="breadcrumb">
    ...
    <li><a href="#">Ubah Koreksi - BOS</a></li>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksinilaispjbos/editkoreksibos.js"></script>
