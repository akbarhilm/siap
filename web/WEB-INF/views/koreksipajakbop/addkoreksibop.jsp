...
<ul class="breadcrumb">
    ...
    <li><a href="#">Entry Koreksi Pajak - BOP</a></li>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Entry Koreksi Pajak - BOP</div>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                <label class="col-md-3 control-label">No BKU Mohon SPJ :</label>
                <div class="col-md-5">
                    <div class="input-group">
            ...
            <div id="labeltriwulan" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="triwulan" id="triwulan" onchange="clearData()">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <form:select path="kodeTransaksi" id="kodeTransaksi" onchange="clearData()" >
                            <form:option value="-">Pilih</form:option>
            ...
            <div id=""  class="form-group">
                ...
                <div class="col-md-9">
                    ...
                    <form:input path="ketKegiatan" id="ketKegiatan" type="text"  class="m-wrap large" size="80" readOnly="true"/> &nbsp;<a  class="fancybox fancybox.iframe btn green" id="pilihKeg" href="${pageContext.request.contextPath}/koreksiPajakBop/listpajak?target='_top'"  title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text" path="tglDok" id="tglDok"  class="required  date-picker2 entrytanggal2 valid" size="14"  />
            ...
            <div id="labeluraian" name="labeluraian" class="form-group">
                ...
                <div class="col-md-4">
                    <form:textarea path="uraian" id="uraian" class="required " cols="80" ROWS="3" />
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/koreksipajakbop/addkoreksibop.js"></script>
