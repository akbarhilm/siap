<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/listsekolah/sekolahlistplt.js"></script>
...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        ...
        $('#npsn', window.parent.document).val($("#npsn" + id).val()).change();
         $('#rekeningBOS', window.parent.document).val($("#rekeningBOS" + id).val()).change();
          $('#rekeningBOP', window.parent.document).val($("#rekeningBOP" + id).val()).change();
