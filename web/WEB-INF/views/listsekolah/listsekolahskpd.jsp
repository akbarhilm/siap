...
<script type="text/javascript">
    ...
    function ambilskpd(id) {
        ...
        $('#rekeningBOP', window.parent.document).val($("#nobop" + id).val()).change();
        $('#rekeningBOS', window.parent.document).val($("#nobos" + id).val()).change();
        $('#namaBOP', window.parent.document).val($("#namabop" + id).val()).change();
        $('#namaBOS', window.parent.document).val($("#namabos" + id).val()).change();
