...
<ul class="breadcrumb">
    ...
    <li><a href="#">Buku Rincian Objek Bendahara Pengeluaran</a></li>
</ul>

<div class="portlet box tosca">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Buku Rincian Objek Bendahara Pengeluaran</div>
    </div>
         ...
         <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                         ...
                         <input type='hidden' id='kodelap' value='02'>
                        ...
                        <c:if test="${isall ==1}"  >  &nbsp; &nbsp;<a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/common/listsekolah?target='_top'" title="Pilih Kegiatan"  ><i class="icon-zoom-in"></i> Pilih</a> </c:if>
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                         <input type="hidden"  id='idKegpop'   />
                         
                        <input type="text" id="keteranganKegPop" readonly="true" class="m-wrap large" size="75"   />
                        &nbsp; &nbsp;<a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/common/listkegiatansekolah?target='_top'" title="Pilih SKPD"  ><i class="icon-zoom-in"></i> Pilih</a> 
