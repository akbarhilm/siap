...
<ul class="breadcrumb">
    ...
    <li><a href="#">Monitoring BKU - BOP</a></li>
</ul>
...
<form:form   method="post" commandName="refmonbkubop"  id="refmonbkubop"   action="" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Monitoring BKU - BOP</div>
            <div class="actions">
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/monitoring/monitoringbkuboptransfer.js"></script>
