...
<ul class="breadcrumb">
    ...
    <li><a href="#">Kartu Kendali Kegiatan Sekolah</a></li>
</ul>

<div class="portlet box tosca">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Kartu Kendali Kegiatan Sekolah</div>
    </div>
         ...
         <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                         ...
                         <input type='hidden' id='kodelap' value='03'>
