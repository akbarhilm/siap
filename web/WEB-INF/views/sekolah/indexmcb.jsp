...
<script src="${pageContext.request.contextPath}/static/js/aplikasi/sekolah/listmcb.js"></script>
...
<ul class="breadcrumb">
    ...
    <li>
        <a href="#"  >Daftar MCB Sekolah</a>
    </li>
</ul>
<div class="portlet box tosca">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Daftar MCB Sekolah</div>
    </div>
        ...
        <div class="form-horizontal" >
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a  href="${pageContext.request.contextPath}/sekolah/tambahmcb" class='btn blue' >Tambah Data</a>
