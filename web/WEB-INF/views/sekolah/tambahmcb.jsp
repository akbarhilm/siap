...
<div class="portlet box tosca">
    ...
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="progcmd"  id="progcmd"  action='javascript:simpan()' class="form-horizontal">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <c:if test="${pengguna.kodeOtoritas==9}"  ><a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/sekolahpopup/listsekolah?target='_top'" title="Pilih Sekolah"  ><i class="icon-zoom-in"></i> Pilih</a> </c:if>
                         <c:if test="${pengguna.kodeOtoritas==0}"  ><a  class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/sekolahpopup/listsekolah?target='_top'" title="Pilih Sekolah"  ><i class="icon-zoom-in"></i> Pilih</a> </c:if>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" id="noMcb"   cssClass="required"  size="15"   maxlength="30"  />
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <input type="text"  id="namaMcb"   cssClass="required ruleCekPassword"  size="50" maxlength="100" />
