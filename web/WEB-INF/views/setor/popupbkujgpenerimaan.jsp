...
<script type="text/javascript">
    ...
    function grid() {
        ...
        $("#popupbkujgpntable").show();
        if (typeof myTable == 'undefined') {
            myTable = $('#popupbkujgpntable').dataTable({
                "bPaginate": true,
                ...
                "bFilter": false,
                "sAjaxSource": getbasepath() + "/setor/json/listpopupbkujgpenerimaan",
                "aaSorting": [[1, "asc"]],
...
<form:form   method="post" commandName="formbkujgpn"  id="formbkujgpn"   action="" class="form-horizontal">
    ...
    <div class="portlet box">
        ...
        <div >
            <table id="popupbkujgpntable" class="table table-striped table-bordered table-condensed table-hover " >
                <thead>
                    <tr>
                        <th>No</th>
                        <th>No BKU Ref</th>
