            ...
            <div id="nilaisetorpane" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        &nbsp; &nbsp;<a id="bkupilihbutton" class="fancybox fancybox.iframe btn green" href="${pageContext.request.contextPath}/setor/listpopupbkujgpenerimaan?target='_top'" title="Pilih BKU"  ><i class="icon-zoom-in"></i>Pilih BKU</a>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/setor/ubahsetorjg.js"></script>
