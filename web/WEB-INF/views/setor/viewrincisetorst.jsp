...
<form:form  method="post" commandName="formsetor"  id="formsetor"   action="${pageContext.request.contextPath}/setor/simpanubahsetor" class="form-horizontal">
    <div class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>View Rinci Setor</div>
        </div>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        ...
                        <form:input path="sekolah.namaSekolah" name="sekolah"  id="sekolah" readonly="true" class="m-wrap large" size="90"   />
            ...
            <div id="nilaisetorpane" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input type="text"  path="nilaiSetor" id="nilaisetor" readonly="true" class="required m-wrap large ruleA03 ruleNilai0" style="text-align:right" size="15"/>
            ...
            <div id="uraianpane" class="form-group">
                ...
                <div class="col-md-5">
                    <div class="input-group">
                        <form:textarea path="uraian" id="uraian" class="required" cols="50" rows="3" maxlength="150" readonly="true" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a class="btn blue"  onclick="tutuppopup()"  >Tutup</a>
                </div>
            </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/setor/viewrincisetorst.js"></script>
