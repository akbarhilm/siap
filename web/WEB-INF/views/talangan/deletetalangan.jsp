...
<ul class="breadcrumb">
    ...
    <li><a href="#">Delete Pagu Talangan</a></li>
    ...
    <div onload="" class="portlet box tosca">
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labeljenis" name="labeljenis" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <select name="jenis" id="jenis" disabled="true" >
            ...
            <div id="labelnilaibku" name="labelnilaibku" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="danaTalangan" id="danaTalangan" type="text"  class="required " readonly="true"/>
                </div>
            </div>
            ...
            <div id="labelnrkpptk" name="labelnrkpptk" class="form-group">
                ...
                <div class="col-md-4">
                    <form:input path="nrk" id="nrk" type="text"  class="required " maxlength="6" readonly="true"/>
            ...
            <div id="labeluraian" name="labeluraian" class="form-group">
                ...
                <div class="col-md-4">
                    <form:textarea readonly="true" path="uraian" id="uraian" class="required " cols="80" ROWS="3" maxlength="400" />
                </div>
            </div>
