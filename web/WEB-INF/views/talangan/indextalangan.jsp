...
<form:form   method="post" commandName="reftalangan"  id="reftalangan"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title"> <!-- cogs-->
            <div class="caption"><i class="icon-cogs"></i>Entry Pagu Talangan</div>
            <div class="actions">
                <a onclick="" href="${pageContext.request.contextPath}/danatalangan/adddanatalangan"  class="btn dark"  ><i class="icon-plus"></i> Tambah</a>
            </div>
        </div>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div class="form-actions fluid">
                <div class="col-md-offset-3 col-md-9">
                    <button id="unduh"  type="button"  class="btn blue" onclick="cetak()"> Unduh XLS </button>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/talangan/indextalangan.js"></script>
