...
<ul class="breadcrumb">
    ...
    <li><a href="#">Pembatalan Transfer - BOP</a></li>
</ul>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pembatalan Transfer - BOP</div>
        </div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/transfer/bataltransferbop.js"></script>
