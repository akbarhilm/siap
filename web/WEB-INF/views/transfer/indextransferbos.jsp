...
<ul class="breadcrumb">
    ...
    <li><a href="#">Pembayaran Buku Kas Umum Sekolah - BOS</a></li>
</ul>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca ">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Pembayaran Buku Kas Umum Sekolah - BOS</div>
        ...
        <div class="portlet-body flip-scroll">
            ...
            <div id="labeltriwulan" class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:select path="triwulan" id="triwulan" onchange="gridtransfer()" >
            ...
            <table id="jourtable" class="table table-striped table-bordered table-condensed table-hover " >
                ...
                <thead  >
                    <tr>
                        ...
                        <th rowspan="2">Konfirmasi VA</th>
                    </tr>
                    <tr>
                        <th style="width: 8%"><input type="text"  style="border:none;margin:0;width:98%;" id="nobkufilter" onkeyup="carinobku()"  /></th>
                        <th style="width: 8%"><input type="text"  style="border:none;margin:0;width:98%;" id="nobuktifilter" onkeyup="carinobukti()"  /></th>
                    </tr>
                </thead>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/transfer/indextransferbos.js"></script>
