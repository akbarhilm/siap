...
<ul class="breadcrumb">
    ...
    <li><a href="#">Konfirmasi Pembayaran BKU (Virtual Account) - BOS</a></li>
...
<form:form   method="post" commandName="refbku"  id="refbku"   action="${pageContext.request.contextPath}/spj/prosessimpan" class="form-horizontal">
    <div onload="" class="portlet box tosca">
        <div class="portlet-title">
            <div class="caption"><i class="icon-cogs"></i>Konfirmasi Pembayaran BKU (Virtual Account) - BOS</div>
...
<script  type="text/javascript" src="${pageContext.request.contextPath}/static/js/aplikasi/transfer/transfervabos.js"></script>
