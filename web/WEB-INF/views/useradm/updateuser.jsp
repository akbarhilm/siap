...
<ul class="breadcrumb">
    ...
    <li><a href="#">Ubah Pengguna<span id='statusaddedit'></span></a></li>
</ul>
<div class="portlet box tosca">
    <div class="portlet-title">
        <div class="caption"><i class="icon-cogs"></i>Form Ubah User</div>
    </div>
    <div class="portlet-body flip-scroll">
        <form:form  method="post" commandName="progcmd"  id="progcmd"  action='${pageContext.request.contextPath}/useradm/updateuser' class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <button class="dark" type='button' onclick="wspeg()">Cek</button>
                    </div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        <form:input  path="idSandi" id="idSandi"   cssClass="required ruleCekPassword"  size="16" maxlength="16" />
